...
type CalendarClient interface {
	...
	EventsByPeriodAndOwner(ctx context.Context, in *EventListRequest, opts ...grpc.CallOption) (*EventListResponse, error)
}
...
func (c *calendarClient) EventsByPeriodAndOwner(ctx context.Context, in *EventListRequest, opts ...grpc.CallOption) (*EventListResponse, error) {
	out := new(EventListResponse)
	err := c.cc.Invoke(ctx, "/event.Calendar/EventsByPeriodAndOwner", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CalendarServer interface {
	...
	EventsByPeriodAndOwner(context.Context, *EventListRequest) (*EventListResponse, error)
...
func (UnimplementedCalendarServer) EventsByPeriodAndOwner(context.Context, *EventListRequest) (*EventListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EventsByPeriodAndOwner not implemented")
}
...
func _Calendar_EventsByPeriodAndOwner_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EventListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CalendarServer).EventsByPeriodAndOwner(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/event.Calendar/EventsByPeriodAndOwner",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalendarServer).EventsByPeriodAndOwner(ctx, req.(*EventListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Calendar_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "EventsByPeriodAndOwner",
			Handler:    _Calendar_EventsByPeriodAndOwner_Handler,
		},
	},

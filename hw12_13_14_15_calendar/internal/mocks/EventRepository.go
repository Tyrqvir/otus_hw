...
func (_m *EventRepository) CreateEvent(ctx context.Context, e model.Event) (model.EventID, error) {
	ret := _m.Called(ctx, e)
...
func (_m *EventRepository) DeleteEvent(ctx context.Context, eID model.EventID) (bool, error) {
...
func (_m *EventRepository) EventsByPeriodForOwner(ctx context.Context, ownerID model.OwnerID, startDate time.Time, endDate time.Time) ([]model.Event, error) {
...
func (_m *EventRepository) NoticesByNotificationDate(ctx context.Context, date time.Time) ([]model.Notice, error) {
...
func (_m *EventRepository) TruncateOlderEvents(ctx context.Context, date time.Time) error {
	ret := _m.Called(ctx, date)
...
func (_m *EventRepository) UpdateEvent(ctx context.Context, e model.Event) (bool, error) {
	ret := _m.Called(ctx, e)
...
func (_m *EventRepository) UpdateIsNotified(ctx context.Context, id model.EventID, isNotified int64) error {
